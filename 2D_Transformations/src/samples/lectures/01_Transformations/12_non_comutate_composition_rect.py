...
if __name__ == '__main__':
    ...
    scene.add_animations(
        ...
        TrsTransformationAnimation(end=S, channel=ID_COMPOSITION, apply_geometry_transformation_on_finish=True),

        TrsTransformationAnimation(end=T, channel=ID_COMPOSITION, apply_geometry_transformation_on_finish=True),
        TrsTransformationAnimation(end=R, channel=ID_COMPOSITION, apply_geometry_transformation_on_finish=True),
    )
